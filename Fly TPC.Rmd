...
fit_G027 <- nls_multstart(Count~deutsch_2008(temp = G1, 
                          ...
                          data = filter( Fly_data, G0 == 27 ),
                          iter = 5000,
                          start_lower = c(rmax=0, topt=19, ctmax = 27.01,a =1), 
                          start_upper =  c(rmax=30, topt=27, ctmax = 35,a =5), 
                          lower =  c(rmax=0,  topt=19,  ctmax = 27.01,a =0),  #  <<<<<< raising ctmax floor to help fitting
                          upper = upper_lims,
                          supp_errors = 'Y')
...
####
# Trying different distributions with custom function
